...
Combined copy of the `analysis_guide` Markdown files from `Shafaatyark/Tariffs-RAs` branch `DY--Analysis`.

---

<!-- Source: analysis_guide/00a_analysis_guide.md -->

# Analysis Guide

This guide explains the main analysis workflow for the tariff project.
...
flowchart LR
    subgraph TSUS["TSUS Pipeline"]
        A["Append"] --> B["Fix Suffixes"]
        B --> C["Clean Duties"]
    end

    subgraph DIAG["Diagnostics & Figures"]
        D["Generate Diagnostics & Figures"]
    end
...
Click each file below to open the workflow page.

| Chart Label | File | Main Output | Purpose |
|---|---|---|---|
| Append | [01a_append.do](01a_append.md) | `tsus_appended.dta` | Import, reshape, and append schedules 1-8 |
| Fix Suffixes | [01b_suffix_fix.do](01b_suffix_fix.md) | `tsus_uncorrected.dta` | Clean suffix codes, fill rates, expand suffix rows, and create uncorrected TSUS data |
| Clean Duties | [01c_clean_duties.do](01c_clean_duties.md) | `tsus_final.dta` | Clean duty variables and save final TSUS data |
| Diagnostics & Figures | [01d_diagnostics.do](01d_diagnostics.md) | figures and diagnostic output | Generate tariff-rate figures and diagnostic output |
| Merge Trade | [02_merge.do](02_merge.md) | `tsus_final_weights.dta`, `trade_appended.dta`, `tsus_trade_merged.dta` | Merge TSUS data with annual import trade data |
| Reference | [Stata Basics and Workflow Guide for Research Assistants](../guide_stata_basics.md) | Stata reference guide | Beginner-friendly reference for common Stata commands useful for RA work |
| Reference | [Tariff Project Do-File and Data-Pipeline Guide](../guide_projTariffRA_dofile.md) | Project do-file guide | Project-specific reference for Stata commands used across the tariff analysis scripts |


---

<!-- Source: analysis_guide/01a_append.md -->

# 01a_append.do Workflow

[Back to Analysis Guide](./00a_analysis_guide.md)
...
Before appending the schedules, the script also standardizes key identifier variables. `item` and `suffix` are converted to strings to preserve code formatting, and `flag` and `unit_spec` are converted to strings when Stata imports them as numeric. This prevents type mismatches across schedules without relying on `append, force`.

## Input Files

- `Analysis\Data Files\Raw Files\TSUS_data\verified_schedule1_test.xlsx`
- `Analysis\Data Files\Raw Files\TSUS_data\verified_schedule2_test.xlsx`
- ...
- `Analysis\Data Files\Raw Files\TSUS_data\verified_schedule8_test.xlsx`

## Output File

- `Analysis\Data Files\Stata Files\tsus_appended.dta`

## Full Commented 01a_append.do Code
...
<!-- Source: analysis_guide/01b_suffix_fix.md -->

# 01b_suffix_fix.do Workflow
...
- `Analysis\Data Files\Stata Files\tsus_uncorrected.dta`

## Full Commented 01b_suffix_fix.do Code
...
<!-- Source: analysis_guide/01c_clean_duties.md -->

# 01c_clean_duties.do Workflow
...
- `Analysis\Data Files\Stata Files\tsus_final.dta`
- `Analysis\Codes\01c_clean_duties_log.smcl`

## Full Commented 01c_clean_duties.do Code

This script contains the data-changing parts from the former histogram step. It does not create figures. Its job is to turn `tsus_uncorrected.dta` into the final tariff dataset that later scripts read.
...
<!-- Source: analysis_guide/01d_diagnostics.md -->

# 01d_diagnostics.do Workflow
...
- `Analysis\Codes\01d_diagnostics_log.smcl`
- `Analysis\Figures\Histogram_ad1_1968.pdf`
- `Analysis\Figures\Histogram_ad1_1972.pdf`
- `Analysis\Figures\Histogram_ad2_1968.pdf`
- `Analysis\Figures\Histogram_ad2_1972.pdf`
- `Analysis\Figures\1968_1972_adval_1_scatter.pdf`
- `Analysis\Figures\1968_1972_adval_2_scatter.pdf`
- `Analysis\Figures\1968_1972_adval_1_scatter_after_fix.pdf`
- `Analysis\Figures\1968_1972_adval_2_scatter_after_fix.pdf`
- `Analysis\Figures\1968_1975_box_whisker.pdf`
- `Analysis\Figures\Histogram_ad1_1968_after_fix.pdf`
- `Analysis\Figures\Histogram_ad1_1972_after_fix.pdf`
- `Analysis\Figures\Histogram_ad2_1968_after_fix.pdf`
- `Analysis\Figures\Histogram_ad2_1972_after_fix.pdf`
- `Analysis\Figures\1968_1972_scatter_outliers.pdf`

## Full Commented 01d_diagnostics.do Code

This script contains the figure and diagnostic-output parts from the former histogram step. It reads `tsus_final.dta`, creates graphs and lists, and closes the log without saving a dataset.
...
<!-- Source: analysis_guide/02_merge.md -->

# 02_merge.do Workflow
...
- `Analysis\Data Files\Stata Files\tsus_final.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1968\Imports-1968.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1969\Imports-1969.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1970\Imports-1970.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1971\Imports-1971.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1972\Imports-1972.dta`
- `Analysis\Data Files\Raw Files\Trade_data\1976\Imports-1976.dta`

## Output Files

- `Analysis\Data Files\Stata Files\tsus_final.dta`
- `Analysis\Data Files\Stata Files\tsus_final_weights.dta`
- `Analysis\Data Files\Stata Files\trade_appended.dta`
- `Analysis\Data Files\Stata Files\tsus_trade_merged.dta`
- `Analysis\Codes\02_merge_log.smcl`

## Full Commented 02_merge.do Code
